...
放射性由radialGradient引入, cx,cy决定中心 r 决定渐变的半径 
...
<text text-anchor="middle" text-anchor="middle" x="50%" y="90%" class="gradient-text" fill="grey_blue">渐变色</text>
```
